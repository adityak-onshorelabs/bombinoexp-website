      ...
      `}</style>
			...
			<div className="fixed top-6 right-6 z-50 print:hidden">
				<button
					...
					className="flex items-center gap-2 bg-[#112330] text-white font-bold px-5 py-3 rounded-xl shadow-xl border border-slate-700 hover:bg-[#1a3347] active:scale-95 transition-all cursor-pointer">
					<svg
						className="w-5 h-5 text-[#F2A123]"
						fill="none"
						stroke="currentColor"
						viewBox="0 0 24 24">
						<path
			...
			<div className="w-full max-w-[210mm] mx-auto bg-white text-black p-6 print:p-0 print:m-0 text-xs leading-snug font-sans">
				...
				<div className="print:block">
					{/* Corporate Header */}
					<div className="flex justify-between items-end border-b-2 border-[#112330] pb-3 mb-4">
						<div>
							<h1 className="text-xl font-black tracking-wider text-[#112330]">
								BOMBINO
							</h1>
							<p className="text-[9px] font-bold tracking-widest uppercase text-[#F2A123]">
								EXPRESS
							</p>
						</div>
						<div className="text-right">
							<h2 className="text-sm font-bold text-[#112330]">{pageTitle}</h2>
				...
				<div className="print:block pt-0">
					{/* Header */}
					<div className="border-b-2 border-[#112330] pb-1 mb-2">
						<h2 className="text-base font-bold text-[#112330]">
					...
					<div className="space-y-1.5">
						{/* Identity */}
						<div>
							<label className="block font-bold uppercase text-[11px] text-[#112330] mb-1 border-b border-slate-100 pb-0.5">
