...
export default function KycPage() {
  ...
  return (
    <main className="font-sans text-[#112330] bg-[#F8F9FA]">
      <section className="bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto py-12 px-6 lg:px-12">
          <h1 className="text-4xl lg:text-6xl font-black text-[#112330] tracking-[-0.03em] mb-6">
            {hero.title}
          </h1>
          ...
          <p className="mt-8 text-sm lg:text-base text-slate-600">
            ...
            <a
              ...
              className="font-semibold text-[#112330] underline decoration-[#F2A123]/70 underline-offset-4 hover:text-[#F2A123] transition-colors"
            >
              {contact.email}
            </a>{" "}
            ...
            <a
              ...
              className="text-[#F2A123] hover:underline font-medium"
            >
              Click here
            </a>
          </p>
      ...
      <section className="py-10 lg:py-12 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto">
          <div className={`${CARD_CLASS} bg-[#FFFCF2] border-[#F2A123]/25`}>
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">
              Document Rules
            </p>
            <h2 className="text-3xl lg:text-4xl font-bold text-[#112330] tracking-[-0.03em] mb-4">
              {documentRules.title}
            </h2>
            <p className="text-slate-600 leading-relaxed mb-4">{documentRules.description}</p>
            <p className="font-semibold text-[#112330] mb-5">{documentRules.requirement}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
              {documentRules.acceptedIds.map((idProof) => (
                ...
                >
                  <svg className="w-4.5 h-4.5 text-[#F2A123] shrink-0" viewBox="0 0 18 18" fill="none" aria-hidden="true">
                    <path d="M3 9 L7 13 L15 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <span className="text-sm font-medium text-[#112330]">{idProof}</span>
                </div>
              ))}
            </div>
            ...
            <div className={`${CARD_CLASS} space-y-8`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <input id="uploadId" name="uploadId" type="file" required className={`${INPUT_CLASS} file:mr-3 file:rounded-md file:border-0 file:bg-[#112330] file:px-3 file:py-1.5 file:text-xs file:font-semibold file:text-white hover:file:bg-[#0b1a24]`} />
                </div>
              </div>
              </div>
              ...
              <div className="flex flex-col items-start gap-3 pt-2">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center bg-[#112330] text-white rounded-xl px-8 py-4 text-sm lg:text-base font-bold tracking-wide hover:bg-[#0b1a24] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F2A123]"
                >
                  Submit KYC Form
                </button>
                {submitted && (
