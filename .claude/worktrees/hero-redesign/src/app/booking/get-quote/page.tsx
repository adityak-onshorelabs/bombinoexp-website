...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-base font-extrabold text-[#112330] tracking-tight mb-5 pb-3 border-b border-slate-100">
      {children}
    </h2>
  );
}
          ...
          <div className="bg-white rounded-2xl border border-slate-200/80 shadow-xl overflow-hidden">
            ...
            <div className="px-6 sm:px-10 pb-10 space-y-6">
              <div className="bg-[#F8F9FA] rounded-xl p-5 border border-slate-100">
                <p className="text-[0.65rem] font-bold tracking-[0.18em] uppercase text-[#F2A123] mb-1">Estimated Rate</p>
                <p className="text-2xl font-black text-[#112330]">
                  {calculatedRange ?? "Custom Contract Pricing Applies"}
                </p>
                <p className="text-xs text-slate-500 mt-1">Inclusive of fuel surcharge</p>
              </div>

              <div className="bg-[#112330]/4 rounded-xl p-4 text-sm text-slate-600 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={reset}
                  className="flex-1 bg-[#112330] text-white font-bold py-3 rounded-lg hover:bg-[#1a3347] transition-colors duration-200"
                >
                  Calculate Another Quote
                </button>
                <a
                  href="/contact"
                  className="flex-1 text-center border border-slate-200 text-[#112330] font-semibold py-3 rounded-lg hover:border-[#F2A123] hover:text-[#F2A123] transition-colors duration-200"
                >
                  Speak to Our Team
                </a>
              </div>
