...
const howItWorksIcons = [
  ...
  <svg key="network" className="w-6 h-6 text-[#F2A123]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <main className="font-sans text-[#112330]">
      ...
      <section className="bg-[#F8F9FA] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">Process</p>
            <h2 className="text-4xl lg:text-5xl font-bold text-[#112330] leading-tight tracking-[-0.03em] mb-4">
              {howItWorks.title}
            </h2>
      ...
      <section className="bg-[#F8FAFC] py-16 lg:py-24 border-t border-slate-100 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl">
            <h2 className="text-4xl lg:text-5xl font-bold text-[#112330] leading-tight tracking-[-0.03em] mb-8">
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">Benefits</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {whyChooseUs.items.map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-4 bg-[#F8F9FA] rounded-2xl p-6 border border-slate-100 hover:border-[#F2A123]/30 transition-colors duration-300"
              >
                <div className="shrink-0 w-8 h-8 rounded-lg bg-[#F2A123]/10 flex items-center justify-center mt-0.5">
                  <svg className="w-4.5 h-4.5 text-[#F2A123]" viewBox="0 0 18 18" fill="none" aria-hidden="true">
