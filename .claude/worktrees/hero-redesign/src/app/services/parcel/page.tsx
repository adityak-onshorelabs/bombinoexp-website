    ...
    <main className="font-sans text-[#112330]">
      ...
      <section className="bg-[#F8F9FA] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">Our Offerings</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreServices.items.map((item, i) => (
              <div 
                key={i} 
                className="group relative bg-white rounded-[2rem] p-10 lg:p-12 overflow-hidden border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:border-[#F2A123]/30 transition-all duration-500 flex flex-col h-full cursor-pointer"
              >
                {/* Number watermark */}
                ...
                <div className="relative z-10 flex-1 flex flex-col">
                  <div className="w-14 h-14 rounded-xl bg-[#F2A123]/10 flex items-center justify-center mb-8 shrink-0">
                     <svg className="w-6 h-6 text-[#F2A123]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <section className="bg-white py-16 lg:py-24 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14 text-center">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">Performance</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {shippingTimelines.features.map((feature, i) => (
              <div 
                key={i}
                className="flex flex-col gap-5 p-8 rounded-2xl bg-[#F8F9FA] border border-slate-100 hover:border-[#F2A123]/30 hover:-translate-y-1 transition-all duration-300"
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm shrink-0">
                    <svg className="w-5 h-5 text-[#F2A123]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-[#F2A123] leading-tight">
                    {feature.title}
                  </h3>
                </div>
      ...
      {/* ══ CONTACT CTA BANNER ══════════════════════════════════════ */}
      <section className="bg-[#112330] py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-12 w-full justify-center">
            ...
            >
              ...
              <span className="text-2xl lg:text-3xl font-bold text-[#F2A123] group-hover:scale-105 transition-transform duration-300">
                {contactInfo.phone}
              </span>
            </a>
