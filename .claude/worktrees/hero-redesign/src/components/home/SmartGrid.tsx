          ...
          <div key={city} className="flex items-center">
            <div className="flex flex-col items-center gap-1.5">
              ...
              <span className="text-[0.58rem] font-semibold tracking-wide whitespace-nowrap hidden sm:block"
                style={{ color: isActive ? "oklch(73% 0.160 64)" : "oklch(52% 0.035 246 / 0.55)" }}>
                {city}
              </span>
            </div>
            ...
            {!isLast && (
              <div className="relative mx-2 h-px w-10 sm:w-14 bg-border-subtle overflow-hidden">
                <motion.div
                  ...
                  style={{ background: "oklch(37% 0.092 245)" }}
      ...
      <section aria-labelledby="bento-heading" className="bg-freight-paper">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8 py-24 lg:py-32">
          ...
          <div className="mb-12">
            ...
            <h2
              id="bento-heading"
              className="font-extrabold text-admiralty leading-[1.05] tracking-[-0.03em]"
          ...
          <div className="cap-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:grid-rows-2">
            ...
            <motion.div
              className="cap-block lg:row-span-2 rounded-2xl bg-admiralty p-8 flex flex-col gap-6 group cursor-default"
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span
                  className="text-4xl font-black leading-none select-none text-freight-paper/10"
                  aria-hidden="true"
                >
                  01
                </span>
              ...
              <div className="mt-auto">
                <h3 className="text-xl font-bold text-freight-paper leading-snug">Global Reach</h3>
                <p className="text-freight-paper/60 text-sm mt-3 leading-relaxed">
                  Seamless freight corridors connecting India to 150+ countries worldwide.
                </p>
              </div>
              <div className="pt-4 border-t border-freight-paper/10">
                <p className="text-dispatch-amber text-3xl font-black tabular-nums">150+</p>
                <p className="text-freight-paper/40 text-xs mt-1 font-medium tracking-wide uppercase">Countries served</p>
              </div>
            </motion.div>

            {/* Card 2 — Secure Handling: standard */}
            <motion.div
              className="cap-block rounded-2xl border border-border-subtle bg-white p-7 flex flex-col gap-5 group hover:border-dispatch-amber/25 hover:[box-shadow:0_8px_32px_oklch(17%_0.048_248_/_0.08)] transition-all duration-300 cursor-default"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              viewport={{ once: true, amount: 0.1 }}
            >
              <div className="flex items-start justify-between">
                ...
                <span
                  ...
                  style={{ color: "oklch(92% 0.010 246)" }}
                  aria-hidden="true"
                >
                  02
                </span>
              ...
              <div>
                <h3 className="text-lg font-bold text-admiralty leading-snug">Secure Handling</h3>
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-bold text-admiralty leading-snug">Time Critical</h3>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col sm:flex-row sm:items-start gap-8">
                ...
                <div className="flex-shrink-0 flex flex-col gap-4">
                  ...
                  {/* Live badge */}
                  <div className="flex items-center gap-2 w-fit px-3 py-1.5 rounded-full bg-[#F2A123]/8 border border-[#F2A123]/20">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F2A123] opacity-60" />
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F2A123]" />
                    </span>
                    <span className="text-[0.65rem] font-bold tracking-[0.14em] uppercase text-[#F2A123]">Live</span>
                  </div>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <h3 className="text-xl font-bold text-admiralty leading-snug">Real-Time Tracking</h3>
                    <span
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start relative">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-32 self-start flex flex-col gap-6">
              ...
              <h2
                ...
                className="font-extrabold text-admiralty leading-[1.03] tracking-[-0.035em]"
              ...
              <Link
                href="/services"
                className="inline-flex items-center gap-2 text-sm font-semibold text-admiralty hover:text-trade-wind transition-colors duration-200 group/link w-fit"
              >
              ...
              <div className="svc-list border-t border-slate-200 mt-6">
                {services.map((svc) => (
                  <a
                    key={svc.title}
                    href={svc.href}
                    className="svc-row grid grid-cols-12 gap-4 items-center py-5 border-b border-slate-100 group cursor-pointer"
                    aria-label={`${svc.title} — ${svc.tagline}`}
                  >
                    <div className="col-span-1">
                      <span className="text-sm font-bold text-[#F2A123]/60 group-hover:text-[#F2A123] transition-colors duration-200 tabular-nums">
                        {svc.number}
                      </span>
                    </div>

                    <div className="col-span-1">
                      <div className="p-2 rounded-lg bg-surface-tinted text-trade-wind group-hover:bg-dispatch-amber/10 group-hover:text-dispatch-amber transition-all duration-200 w-fit">
                        <svc.icon className="w-4.5 h-4.5" aria-hidden="true" />
                      </div>
                    </div>

                    <div className="col-span-8 min-w-0">
                      <p className="font-semibold text-admiralty text-[0.9375rem] leading-snug group-hover:text-trade-wind transition-colors duration-200">
                        {svc.title}
                      </p>
                    ...
                    <div className="col-span-2 flex justify-end">
                      <span
                        className="text-muted-ink/30 group-hover:text-admiralty group-hover:translate-x-1 transition-all duration-200 text-base"
                        aria-hidden="true"
                      >
                        →
                      </span>
