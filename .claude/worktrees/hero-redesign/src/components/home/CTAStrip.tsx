  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 70% 100% at 50% 100%, oklch(17% 0.048 248 / 0.12) 0%, transparent 80%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        >
          <p className="text-eyebrow text-admiralty/50 text-center">Ready to ship?</p>

          <h2
            id="cta-heading"
            className="font-extrabold tracking-tight text-admiralty leading-tight text-center"
            style={{ fontSize: "clamp(2rem, 4.5vw, 3.5rem)" }}
          >
            Move anything, anywhere.
          </h2>

          <p className="text-admiralty/60 text-base lg:text-lg leading-relaxed text-center max-w-[52ch]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mt-3">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center px-8 rounded-full border-2 border-admiralty/30 text-admiralty text-sm font-semibold tracking-wide transition-all duration-200 hover:border-admiralty/60 hover:bg-admiralty/8 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-admiralty/30"
              style={{ height: 52 }}
            >
              Contact Us
            </Link>
