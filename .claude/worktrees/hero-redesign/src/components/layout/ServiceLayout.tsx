...
interface ServiceData {
  ...
  fulfillmentServices?: { title: string; items: Array<{ title: string; description: string }> };
...
export default function ServiceLayout({ data, layoutVariant = "default", bottomSectionVariant = "ecommerce" }: ServiceLayoutProps) {
  ...
  return (
    <main className="font-sans text-[#112330]">
      ...
      <div ref={horizontalRef} className="overflow-x-hidden bg-[#F8F9FA] pt-20 pb-4 relative">
        {/* Dot-matrix overlay */}
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          <svg width="100%" height="100%">
            <defs>
              <pattern id="hsDots" x="0" y="0" width="28" height="28" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1" fill="#112330" opacity="0.04" />
              </pattern>
            </defs>
        ...
        {/* Pinned Title Bar */}
        <div className="absolute top-0 left-0 w-full z-10 bg-[#F8F9FA] px-6 lg:px-12 pt-16 pb-8 border-b border-slate-200">
          <div className="max-w-7xl mx-auto">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">
              {data.howItHelps?.title}
            </p>
            <h2 className="font-black text-[#112330] leading-[0.9] tracking-[-0.04em]" style={{ fontSize: "clamp(1.8rem, 3.8vw, 3rem)" }}>
              {data.howItHelps?.title}
            </h2>
          </div>
        </div>
        ...
        >
          {data.howItHelps?.items.map((card, i) => (
            ...
            >
              <div className="min-h-[480px] lg:min-h-[520px] bg-white rounded-[2rem] p-10 lg:p-12 flex flex-col justify-between relative overflow-hidden group shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 hover:border-[#F2A123]/30 transition-all duration-500">
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-center w-full">
                  <h3 className="font-black text-[#112330] leading-tight tracking-[-0.03em] mb-6 text-3xl lg:text-4xl w-full">
                    {card.title}
                  </h3>
      ...
      <section className="bg-white py-24 lg:py-36">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="mb-16">
            ...
            <h2 className="text-4xl lg:text-6xl font-bold text-[#112330] leading-[0.9] tracking-[-0.03em]">
              {data.fulfillmentServices?.title}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {data.fulfillmentServices?.items.map((item, i) => (
              <GlobalCard key={i} index={i} title={item.title} description={item.description} />
            ))}
          </div>
            ...
            {data.editorial?.sections.map((section, i) => (
              <div key={i} className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                <div className="lg:col-span-4">
                  <h2 className="text-2xl lg:text-3xl font-extrabold text-[#112330] leading-tight tracking-[-0.025em]">
                    {section.title}
                  </h2>
                </div>
                ...
                <div className="min-h-[480px] lg:min-h-[520px] bg-white rounded-[2rem] p-10 lg:p-12 flex flex-col justify-between relative overflow-hidden group shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 hover:border-[#F2A123]/30 transition-all duration-500">
                  ...
                  <div className="flex justify-between items-center relative z-10 mb-8">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#112330]">System Active</span>
                    </div>
                    <span className="text-[0.65rem] font-bold tracking-[0.2em] text-slate-300">
      ...
      {layoutVariant === "warehousing" && (<>
        ...
        <section className="bg-white py-24 lg:py-36">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="mb-14">
              <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">{data.storageTypes?.title}</p>
              <h2 className="text-4xl lg:text-5xl font-bold text-[#112330] leading-tight tracking-[-0.03em] mb-4">{data.storageTypes?.title}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {data.storageTypes?.items.map((item, i) => {
                const icons = [
                  /* Dedicated — box/cube */
                  <svg key="box" className="w-10 h-10" viewBox="0 0 40 40" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 4 L36 12 L36 28 L20 36 L4 28 L4 12 Z"/><path d="M4 12 L20 20 L36 12"/><line x1="20" y1="20" x2="20" y2="36"/></svg>,
                  /* Shared — two overlapping circles */
                  <svg key="share" className="w-10 h-10" viewBox="0 0 40 40" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true"><circle cx="14" cy="20" r="10"/><circle cx="26" cy="20" r="10"/></svg>,
                  /* Temperature — thermometer */
                  <svg key="temp" className="w-10 h-10" viewBox="0 0 40 40" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true"><rect x="16" y="4" width="8" height="22" rx="4"/><circle cx="20" cy="31" r="5"/><line x1="23" y1="10" x2="27" y2="10"/><line x1="23" y1="15" x2="27" y2="15"/><line x1="23" y1="20" x2="27" y2="20"/></svg>,
                  /* Ambient — wave lines */
                  <svg key="wave" className="w-10 h-10" viewBox="0 0 40 40" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true"><path d="M4 16 Q10 10 16 16 Q22 22 28 16 Q34 10 40 16"/><path d="M4 24 Q10 18 16 24 Q22 30 28 24 Q34 18 40 24"/></svg>,
                  /* Bonded — shield */
                  <svg key="shield" className="w-10 h-10" viewBox="0 0 40 40" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M20 4 L34 10 L34 22 C34 30 20 37 20 37 C20 37 6 30 6 22 L6 10 Z"/><path d="M14 20 L18 24 L26 16"/></svg>,
                ];
                return (
                  <div key={i} className="border border-slate-200 rounded-2xl p-8 bg-white hover:border-[#F2A123]/40 hover:shadow-sm transition-all duration-300 flex flex-col gap-5">
                    <div className="w-14 h-14 rounded-xl bg-[#F2A123]/8 flex items-center justify-center">
                      {icons[i % icons.length]}
                    </div>
                    <div>
                      <h3 className="text-xl font-extrabold text-[#112330] mb-2 leading-tight">{item.title}</h3>
        ...
        <section className="bg-[#112330] py-24 lg:py-36">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="mb-14">
              <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123]/60 mb-3">Safety First</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {data.safetyAndSecurity?.features.map((feat, i) => {
                const safetyIcons = [
                  ...
                  <svg key="rack" className="w-8 h-8" viewBox="0 0 32 32" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="4" width="28" height="6" rx="1"/><rect x="2" y="13" width="28" height="6" rx="1"/><rect x="2" y="22" width="28" height="6" rx="1"/><line x1="8" y1="10" x2="8" y2="13"/><line x1="24" y1="10" x2="24" y2="13"/><line x1="8" y1="19" x2="8" y2="22"/><line x1="24" y1="19" x2="24" y2="22"/></svg>,
                  /* Fire Safety — flame */
                  <svg key="flame" className="w-8 h-8" viewBox="0 0 32 32" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M16 2 C16 2 22 10 22 16 C22 19.3 19.3 22 16 22 C12.7 22 10 19.3 10 16 C10 13 12 10 12 10 C12 10 13 14 16 14 C16 14 14 10 16 2Z"/><path d="M16 22 C16 22 10 26 10 28 C10 28 16 30 22 28 C22 28 22 24 16 22Z" strokeDasharray="2 2"/></svg>,
                  /* Access & CCTV — camera */
                  <svg key="cctv" className="w-8 h-8" viewBox="0 0 32 32" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="9" width="20" height="14" rx="2"/><path d="M22 13 L30 9 L30 23 L22 19"/><circle cx="12" cy="16" r="3"/></svg>,
                  /* Quality Control — shield check */
                  <svg key="qc" className="w-8 h-8" viewBox="0 0 32 32" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M16 2 L28 7 L28 18 C28 24 16 30 16 30 C16 30 4 24 4 18 L4 7 Z"/><path d="M11 16 L14 19 L21 12"/></svg>,
                  /* Digital Retrieval — barcode */
                  <svg key="barcode" className="w-8 h-8" viewBox="0 0 32 32" fill="none" stroke="#F2A123" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true"><line x1="4" y1="6" x2="4" y2="22"/><line x1="8" y1="6" x2="8" y2="22"/><line x1="11" y1="6" x2="11" y2="22"/><line x1="15" y1="6" x2="15" y2="22"/><line x1="18" y1="6" x2="18" y2="22"/><line x1="22" y1="6" x2="22" y2="22"/><line x1="25" y1="6" x2="25" y2="22"/><line x1="28" y1="6" x2="28" y2="22"/><line x1="2" y1="26" x2="14" y2="26"/><line x1="18" y1="26" x2="30" y2="26"/></svg>,
                ];
                return (
                  <div key={i} className="flex flex-col gap-5 p-6 rounded-2xl bg-white/5 border border-white/8 hover:border-[#F2A123]/30 transition-colors duration-300">
                    <div className="w-12 h-12 rounded-xl bg-[#F2A123]/10 flex items-center justify-center">
        ...
        <section className="bg-[#F8F9FA] py-24 lg:py-36">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="rounded-3xl bg-[#112330] p-10 lg:p-12 flex flex-col gap-8">
                <div>
                  <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123]/60 mb-3">VIP Service</p>
                ...
                <ul className="flex flex-col gap-5">
                  {data.concierge?.features.map((feat, i) => (
                    <li key={i} className="flex items-start gap-3.5">
                      <span className="shrink-0 mt-[7px] w-2 h-2 rounded-full bg-[#F2A123]" />
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-10 lg:p-12 flex flex-col gap-8">
                <div>
                  <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123]/60 mb-3">Compliance</p>
                  <h2 className="text-3xl lg:text-4xl font-bold text-[#112330] leading-tight tracking-[-0.03em]">{data.ior?.title}</h2>
                </div>
                  ...
                  {data.ior?.features.map((feat, i) => (
                    <li key={i} className="flex items-start gap-3.5">
                      <span className="shrink-0 mt-[6px] relative flex h-2.5 w-2.5">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F2A123] opacity-40" />
                        <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#F2A123]" />
                      </span>
      ...
      {bottomSectionVariant === "air" && (
        <section className="bg-white py-24 lg:py-36">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-12">
            ...
            <div className="relative rounded-[3rem] bg-[#112330] p-12 lg:p-20 overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12 shadow-2xl">
              ...
              <div className="relative z-10 lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                {data.concierge?.features.map((feat: string, i: number) => (
                  <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                    <div className="w-2 h-2 rounded-full bg-[#F2A123] animate-pulse shrink-0" />
            ...
            <div className="pt-12 border-t border-slate-100 grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-1">
                <h2 className="font-black text-[#112330] text-3xl lg:text-4xl mb-4 tracking-tight">{data.ior?.title}</h2>
              ...
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                {data.ior?.features.map((feat: string, i: number) => (
                  <div key={i} className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#F2A123] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      {bottomSectionVariant === "ocean" && (
        <section className="relative bg-gradient-to-b from-[#112330] to-[#081017] py-24 lg:py-36 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 gap-4">
              ...
              >
                <div>
                  <p className="text-[0.6rem] font-bold tracking-[0.2em] uppercase text-[#F2A123]/60 mb-3">Ocean Management</p>
                ...
                <div className="pt-6 border-t border-white/10 flex items-center gap-2">
                  <span className="relative flex h-2 w-2">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#F2A123] opacity-50" />
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-[#F2A123]" />
                  </span>
                  <span className="text-[0.6rem] font-bold tracking-[0.18em] uppercase text-[#F2A123]/50">Live Operations</span>
                </div>
              </div>
              ...
              >
                <p className="text-[0.6rem] font-bold tracking-[0.2em] uppercase text-[#F2A123]/60">Global Ocean Reliability</p>
                <h2 className="font-black text-white text-3xl lg:text-4xl leading-tight tracking-[-0.03em]">
              ...
              >
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {data.conclusion?.features.map((feat: string, i: number) => (
                    ...
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-[#F2A123] shrink-0" />
      ...
      {bottomSectionVariant === "warehousing" && (
        <section className="bg-[#F8F9FA] py-24 lg:py-36">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="mb-14">
              <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#F2A123] mb-3">Why Choose Us</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {data.benefits?.items.map((item, i) => (
                <div
                  key={i}
                  className="flex items-start gap-4 bg-white rounded-2xl p-6 border border-slate-100 shadow-[0_2px_12px_rgb(0,0,0,0.03)] hover:border-[#F2A123]/30 hover:shadow-[0_4px_20px_rgb(0,0,0,0.06)] transition-all duration-300"
                >
                  <div className="shrink-0 w-8 h-8 rounded-lg bg-[#F2A123]/10 flex items-center justify-center mt-0.5">
                    <svg className="w-4.5 h-4.5" width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="#F2A123" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                      <path d="M3 9 L7 13 L15 5" />
                    </svg>
                  </div>
                  <span className="text-[#112330] font-semibold text-base leading-snug">{item}</span>
                </div>
              ))}
            </div>
          </div>
