    ...
    >
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
        ...
        <FadeUp className="mb-14">
          ...
          <h2 id="capabilities-heading" className="text-headline text-[lab(7.78673_1.82346_-15.0537)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-auto">
          ...
          >
            ...
            <div
              ...
              style={{ background: "linear-gradient(170deg, transparent 25%, oklch(17% 0.048 239.763 / 0.88) 70%)" }}
              aria-hidden="true"
            />
            <div
          ...
          <motion.div
            ...
            style={{
              minHeight: 210,
              boxShadow: "0 2px 8px oklch(17% 0.048 239.763 / 0.05), 0 1px 2px oklch(17% 0.048 239.763 / 0.04)",
            }}
            ...
            whileHover={{
              ...CARD_LIFT,
              boxShadow: "0 24px 64px oklch(17% 0.048 239.763 / 0.13), 0 6px 16px oklch(17% 0.048 239.763 / 0.07)",
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <motion.div
                className="w-fit"
                style={{ color: "oklch(37% 0.092 239.763)" }}
                whileHover={{
              ...
              <span className="text-5xl font-black leading-none select-none" style={{ color: "oklch(92% 0.010 239.763)" }} aria-hidden="true">02</span>
            </div>
            <div className="mt-auto pt-10">
              <h3 className="text-xl font-bold text-[lab(7.78673_1.82346_-15.0537)]">Secure Handling</h3>
          ...
          >
            <div className="flex justify-between items-start">
              ...
              <span className="text-5xl font-black leading-none select-none" style={{ color: "oklch(92% 0.010 239.763)" }} aria-hidden="true">03</span>
            </div>
            <div className="mt-auto pt-10">
              <h3 className="text-xl font-bold text-[lab(7.78673_1.82346_-15.0537)]">Time Critical</h3>
              <p className="text-muted-ink text-sm mt-2 leading-relaxed">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex justify-between items-start">
                {/* Trending-up icon */}
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="oklch(37% 0.092 239.763)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <polyline points="22 7 13.5 15.5 8.5 10.5 2 17" />
                  <polyline points="16 7 22 7 22 13" />
                </svg>
                <span className="text-5xl font-black leading-none select-none" style={{ color: "oklch(90% 0.010 239.763)" }} aria-hidden="true">04</span>
              </div>
              <div className="mt-8">
                <h3 className="text-xl font-bold text-[lab(7.78673_1.82346_-15.0537)]">Real-Time Tracking</h3>
