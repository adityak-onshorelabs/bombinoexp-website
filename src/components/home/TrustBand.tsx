    ...
    >
      ...
      <div className="relative">
        <div
          ...
          style={{ background: "linear-gradient(to right, oklch(98% 0.004 239.763), transparent)" }}
          aria-hidden="true"
        />
        <div
          className="absolute right-0 top-0 bottom-0 w-20 z-10 pointer-events-none"
          style={{ background: "linear-gradient(to left, oklch(98% 0.004 239.763), transparent)" }}
          aria-hidden="true"
        />
