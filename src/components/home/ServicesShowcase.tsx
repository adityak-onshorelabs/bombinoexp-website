      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <header className="mb-14 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
          <div>
            ...
            <h2
              id="services-heading"
              className="font-bold text-[lab(7.78673_1.82346_-15.0537)]"
          ...
          <Link
            href="/services"
            className="inline-flex items-center gap-2 text-sm font-semibold text-trade-wind hover:text-[lab(7.78673_1.82346_-15.0537)] transition-colors duration-150 shrink-0"
          >
            View all services
          ...
          {services.map(({ id, category, title, desc, href, img, alt }) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, oklch(17% 0.048 239.763 / 0.90) 0%, oklch(17% 0.048 239.763 / 0.50) 40%, transparent 70%)",
                }}
                aria-hidden="true"
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 z-20 p-6 flex flex-col gap-1.5">
                ...
                <p className="text-sm text-[oklch(98%_0.004_239.763_/_0.70)] leading-relaxed max-w-[40ch]">
                  {desc}
                </p>
                {/* Arrow indicator */}
                <div
