...
const featureIcons = [
  ...
  <svg key="check" className="w-6 h-6 text-[#FBAD1F]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <main className="font-sans text-foreground">
      ...
      <section className="bg-[#F8FAFC] py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="mb-14">
            <p className="text-[0.65rem] font-bold tracking-[0.2em] uppercase text-[#FBAD1F] mb-3">Our Advantage</p>
            <h2 className="text-4xl lg:text-5xl font-bold text-foreground leading-tight tracking-[-0.03em]">{features.title}</h2>
          </div>
