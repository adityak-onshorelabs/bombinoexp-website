...
export default function ProhibitedItemsPage() {
	...
	const renderIcon = (iconType: string) => {
		const baseClass = "w-7 h-7 text-[#FBAD1F]";
	...
	return (
		<main className="font-sans bg-[#F8FAFC] min-h-screen pb-20">
			...
			<section className="max-w-7xl mx-auto px-6 lg:px-12 mt-12 lg:mt-16">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					{categories.map((cat, idx) => (
						<div
							...
							<div className="absolute -bottom-4 -right-4 text-[7rem] font-black text-[#FBAD1F]/15 leading-none pointer-events-none select-none transition-transform duration-700 group-hover:scale-110 group-hover:-translate-x-3">
							...
							<div className="relative z-10">
								...
								<div className="flex items-center gap-4 mb-7">
									<div className="w-14 h-14 rounded-xl bg-[#FBAD1F]/10 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform duration-300">
										{renderIcon(cat.icon)}
									</div>
									<h2 className="text-xl lg:text-2xl font-extrabold text-foreground group-hover:text-red-600 transition-colors duration-300">
										{cat.title}
									</h2>
								</div>
				...
				<div className="mt-12 bg-white rounded-2xl p-6 lg:p-8 border-l-4 border-[#FBAD1F] shadow-sm flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
					<div>
					...
					<a
						...
						className="bg-admiralty text-white font-bold text-sm px-6 py-3 rounded-lg hover:bg-[oklch(0.38 0.08 240)] transition-colors shrink-0 inline-block text-center">
